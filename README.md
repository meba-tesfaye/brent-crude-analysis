...
![Python CI Pipeline](https://github.com/meba-tesfaye/brent-crude-analysis/actions/workflows/python-app.yml/badge.svg?branch=main)
...
├── .github/
│   └── workflows/
│       └── ci.yml                # CI/CD workflow running pytest on push
├── data/
